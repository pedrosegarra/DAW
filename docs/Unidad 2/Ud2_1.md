...
- **Balanceador Software:** Por ejemplo, un servidor web Apache junto con el módulo mod_jk, que permite la redirección de las peticiones http entre las distintas máquinas de la granja de servidores.
