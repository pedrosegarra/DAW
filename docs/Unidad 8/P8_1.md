...
Workflow 1
    ...
    3. Ejecuta los tests
```
En la [introducción](#¿qué-es-github-actions) también se ha explicado dónde y cómo se definen estos workflows. Así pues, en el repositorio clonado en nuestra Debian, añadamos la carpeta pertinente:
