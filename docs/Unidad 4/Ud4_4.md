...
- **Usuario de sistema**: será un usuario definido dentro del sistema donde se ofrece el servicio.
...
| Column 1 | Usuario Anónimo | Usuario Autenticado (Local) | Usuario Virtual |
|----------|----------|----------|----------|
...
| Uso Común    | Cell 8   | Cell 9   |  Cell 9   |
